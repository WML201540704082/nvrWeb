...
<template>
  ...
  <div class="mainBox" v-if="passType === 'face'"
    ...
    <div v-if="!passData.length" style="color: #909399; font-size: 14px; text-align: center; width: 100%; height: 100%; line-height: 600px;">暂无数据</div>   
...
export default {
  ...
  data() {
    return {
      ...
      errorFaceImg: 'this.src="' + require('../img/stranger.png') + '"',
      errorBodyImg: 'this.src="' + require('../img/alert.png') + '"',
      errorVehicleImg: 'this.src="' + require('../img/vehicle.png') + '"',
      errorNonmotorImg: 'this.src="' + require('../img/nonMotor.png') + '"'
    }
  },
  methods: {
    showDetail(item) {
