<template>
  <div class="face history-container">
    <div class="filterBox" style="min-width:1040px;">
      <el-col :span="20" style="width:100%;padding: 5px 20px;">
        ...
        <div class="mt20" style="width:85%;">
          ...
          <!-- 性别 -->
          <el-col :span="4" :offset="2" class="filterItem" clearable>
            <el-col :span="4" class="searchTitle">{{ $t('gender') }}</el-col>
            <el-col :span="19" class="flexRowBetween spanBox">
              <el-select v-model="filterParams['gender']" size="mini" @change="filter('gender', filterParams['gender'])"
                ...
                <el-option v-for="(obj, index) of faceList.gender" :key="index" :label="$t(obj.label)" :value="obj.value">
                  {{ $t(obj.label) }}
                </el-option>
              </el-select>
            </el-col>
          ...
          <el-col :span="10" :offset="2" class="filterItem">
            <el-col :span="2" class="searchTitle">{{ $t('time') }}</el-col>
          ...
          <!-- 口罩 -->
          <el-col :span="4" :offset="0" class="filterItem" clearable>
            <el-col :span="4" class="searchTitle">{{ $t('mask') }}</el-col>
            <el-col :span="19" class="flexRowBetween spanBox">
              <el-select v-model="filterParams['mask']" size="mini" @change="filter('mask', filterParams['mask'])"
                style="margin-left:10px" :style="{width: (size.contentWidth > 1600 ? 260 : 180) + 'px'}" clearable>
                <el-option v-for="(obj, index) of faceList.mask" :key="index" :label="$t(obj.label)" :value="obj.value">
                  {{ $t(obj.label) }}
                </el-option>
              </el-select>
            </el-col>
          ...
          <!-- 眼镜 -->
          <el-col :span="4" :offset="2" class="filterItem" clearable>
            <el-col :span="4" class="searchTitle">{{ $t('glass') }}</el-col>
            <el-col :span="19" class="flexRowBetween spanBox">
              <el-select v-model="filterParams['glass']" size="mini" @change="filter('glass', filterParams['glass'])"
                style="margin-left:10px" :style="{width: (size.contentWidth > 1600 ? 260 : 180) + 'px'}" clearable>
                <el-option v-for="(obj, index) of faceList.glass" :key="index" :label="$t(obj.label)" :value="obj.value">
                  {{ $t(obj.label) }}
                </el-option>
              </el-select>
            </el-col>
          ...
          <!-- 帽子 -->
          <el-col :span="10" :offset="2" class="filterItem" clearable>
            <el-col :span="2" class="searchTitle">{{ $t('hat') }}</el-col>
            <el-col :span="10" class="flexRowBetween spanBox">
              <el-select v-model="filterParams['hat']" size="mini" @change="filter('hat', filterParams['hat'])"
                :style="{width: (size.contentWidth > 1600 ? 260 : 180) + 'px'}" clearable>
                <el-option v-for="(obj, index) of faceList.hat" :key="index" :label="$t(obj.label)" :value="obj.value">
                  {{ $t(obj.label) }}
                </el-option>
              </el-select>
            </el-col>
    ...
    <!-- 卡片 -->
    <div class="mainBox record"
      :style="{ width: size.contentWidth - 225 + 'px', height: size.contentHeight - 330 + 'px' }">
...
<script>
import { commonList, faceList } from '../_utils/listMap'
