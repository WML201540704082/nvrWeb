...
export default {
    ...
    data() {
        return {
            ...
            playParams: { lateopen: true,retryTimes: 5000, retryDelay: 10, minBufferSize: 0,maxBufferSize: 0.5,dropBufferSize: 0.5 },
            isLoading: false,
            isCaching: false,
            bboxEnabled: true,
            canvasWidth: null,
            ...
            if (data.refresh) {
                ...
                if (data.playFlag) {
                    ...
                    if ((this.itemRef && this.page16List[this.itemRef.substring(5)-1].chnlId) || !this.itemRef) {
                        ...
                        let pageNum1 = (this.division_show_index != 1 && this.division_show_index != 2 && this.division_show_index != 4 && this.division_show_index != 6 && this.division_show_index != 9 && this.division_show_index != 10) ? (16/this.division_show_index) : 1 //折算后的页码
                        console.log('******a,pageNum1',a,pageNum1);
                        if (this.pageNewNum > pageNum1) {
                            oriPosition = ((this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10) ? (this.pageNewNum-pageNum1) : pageNum1)*this.division_show_index + a
                        } else {
                            oriPosition = a
                        }
    ...
    methods: {
        ...
        initPlayers() {
            ...
            for(let i = 0; i < this.page16List.length; i++) {
                ...
                try {
                    FGPlayer.create({
                        canvas: this.$refs[this.page16List[i].ref][0],
                        enableBBox: this.bboxEnabled,
                        onSizeChange: (width, height) => {
                            console.log("fgplay-sizechange:", i)
                            this.sizeChange(width, height);
                        },
                        onDisconnect: () => {
                            console.log("fgplay-onDisconnect:", i,'this.playParams',this.playParams)
                            this.isLoading = true;
                        },
                        onConnect: () => {
                            console.log("fgplay-onConnect:", i)
                            this.isLoading = false;
                        },
                        onCaching: () => {
                            console.log("fgplay-onCaching:", i)
                            this.isCaching = true;
                        },
                        onCached: () => {
                            console.log("fgplay-onCached:", i)
                        ...
                        player.genOSD(
                            ...
                            this.page16List[i].player = player 
                        })
                    .catch(e => {
                        console.log(e);
                    });
        ...
        getPlayer(channelId) {
            for (let i = 0; i < this.page32List.length; i++) {
                if (this.page32List[i]?.chnlId == channelId) {
                    return (this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10) ? i%this.division_show_index : i%16
                }
            }
            return -1
        },
        ...
        selectEmptyScene(channelId) {
            ...
            if(savePlace > ((this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10) ? this.division_show_index : 16) || 
			this.pageNewNum > ((this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10) ? 1 : (16/this.division_show_index))) {
                ...
                if (pageNum0 == this.pageNewNum && newPage != 1) {
                    ...
                    let pageNum1 = (this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10 || this.division_show_index == 16) ? 1 : ((pageNum0-1)%(16/this.division_show_index)+1)
                    ...
                    for(let i=(pageNum0-1)*this.division_show_index;i<pageNum0*this.division_show_index;i++){
                        if(this.page32List[i]?.chnlId && !this.page16List[(this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10) ? i%this.division_show_index : i%16].chnlId){
                            // 如果32的list有值，16的list没有值 --> 开启播放
                            this.playNewUrl(((this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10) ? i%this.division_show_index : i%16),this.page32List[i]?.chnlId,i+1)
                                            // p(page16List中的index),  channelId,  oriPosition(折算前的格子位置)
                        }
                    }
                }
                this.itemRef = 'scene' + ((this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10) ? ((savePlace-1)%this.division_show_index+1) :
        ...
        changeTopName(index) {
            let realIndex
            // 计算真实的Index
			let pageNum1 = (this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10 || this.division_show_index == 16) ? 1 :
						  (16/this.division_show_index) // 不复用之前的格子最大的页码数
                          console.log('this.pageNewNum',this.pageNewNum,'pageNum1',pageNum1);
            if (this.pageNewNum > pageNum1) {
                realIndex = (this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10 || this.division_show_index == 16) ? (index+this.division_show_index*(this.pageNewNum-1)) : (index+16)
            } else {
                realIndex = index
            }
        ...
        changePage(type) {
            //获取折算后的页码
            this.pageNum = (this.pageNewNum <= Math.ceil(((this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10) ? this.division_show_index : 16)/this.division_show_index)) ? this.pageNewNum :
						   ((this.division_show_index == 1 || this.division_show_index == 2 || this.division_show_index == 4 || this.division_show_index == 6 || this.division_show_index == 9 || this.division_show_index == 10) ? 1 :
