<template>
  <div class="TimeDiv">
    ...
    <div v-for="item in timeArr" :key="item.id">
      <TimeSlider :SubIndex="Index" :record="item" :reloadFlag="reloadFlag" :selectFlag="selectFlag" @updataSelect="onUpdataSelect"  @updataTime="onUpdataTime" />
    </div>
